...
public class CurveAnimation {
     ...
     * 曲线动画
     */
    public CurveAnimation(Context context){
     ...
     */
    @SuppressLint("NewApi")
    public void addCart(View iv,View shop,Bitmap bitmap,final RelativeLayout rl) {
...
//        二、计算动画开始/结束点的坐标的准备工作
        ...
        shop.getLocationInWindow(endLoc);
...
//        三、正式开始计算动画开始/结束的坐标
        ...
        float toX = endLoc[0] - parentLocation[0] + shop.getWidth() / 5;
...
//        path.quadTo((startX + toX) / 2, startY, toX, toY);
        path.quadTo((startX + toX) / 2, startY-(startY/5), toX, toY);
