 ...
 * 自定义形状image
 */
public class NewCircleImageView extends android.support.v7.widget.AppCompatImageView {
    ...
    public NewCircleImageView(Context context, AttributeSet attrs, int defStyleAttr) {
