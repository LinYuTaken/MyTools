...
public class Zhenglistview extends ListView {
	public Zhenglistview(Context context) {
		super(context);

	}

	public Zhenglistview(Context context, AttributeSet attrs) {
		super(context, attrs);

	}

	public Zhenglistview(Context context, AttributeSet attrs, int defStyle) {
