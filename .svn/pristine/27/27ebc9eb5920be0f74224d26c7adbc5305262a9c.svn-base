...
import com.lin.mobile.album.Picture;
import com.lin.mobile.album.SelectedUriCollection;
import com.lin.mobile.album.ImageSelectActivity;
...
//        	imageView.setImageDrawable(test);
...
//            mCollection.getEngine().displayImage(item.buildContentUri().toString(), imageView);
        	ImageLoader.getInstance().displayImage(item.buildContentUri().toString(), imageView);
