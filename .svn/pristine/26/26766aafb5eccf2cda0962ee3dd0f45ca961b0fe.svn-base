...
//                    EMLog.e("HanziToPinyin", "Internal error in Unihan table. The last string \"" + var1 + "\" is greater than current string \"" + var6 + "\".");
     ...
     * @param user
     */
    public static String setUserInitialLetter(String niString) {
        ...
        if (!TextUtils.isEmpty(niString)) {
            return new GetInitialLetter().getLetter(niString);
        } else {
            return letter;
        }
//        if (letter.equals(DefaultLetter) && !TextUtils.isEmpty(user.getUsername())) {
//            return new GetInitialLetter().getLetter(user.getUsername());
//        }
    }
}
